...
/**
 * Checks whether an application window is known and should get Adblock Cash
...
switch (application)
{
  ...
  case "fennec2":
  {
    ...
    UI.updateIconState = function fmn_updateIconState(window, icon)
    {
      ...
      let iconUrl = require("./info").addon.root + "icon64.png";
      ...
      browser.addEventListener("load", function openAddonPrefs(event)
      {
        ...
        Utils.runAsync(function()
        {
          ...
          AddonManager.getAddonsByTypes(["extension", "theme", "locale"], function()
          {
            ...
            event.state = {id: require("./info").addon.id};
