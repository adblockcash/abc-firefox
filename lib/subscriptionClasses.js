...
Subscription.fromObject = function(obj)
{
  ...
  try
  {
    ...
    if ("requiredVersion" in obj)
    {
      ...
      if (Services.vc.compare(result.requiredVersion, addon.version) > 0)
...
DownloadableSubscription.prototype =
{
   ...
   * if the user doesn't use Adblock Cash for some time.
   * @type Number
   */
  get lastCheck()
  {
  ...
  /**
   * Minimal Adblock Cash version required for this subscription
   * @type String
   */
  requiredVersion: null,

  /**
   * Should be true if requiredVersion is higher than current Adblock Cash version
   * @type Boolean
   */
