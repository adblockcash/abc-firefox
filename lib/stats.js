...
let {PageMap, Pages, Page} = require("./pages");

let badgeColor = "#646464";
let statsPerPage = new PageMap();
...
FilterNotifier.addListener(function(action, item, newValue, oldValue, page)
{
  ...
  // page is a Window - let's convert it to a Page object
  if (page && page.document) {
    page = new Page({window: page, url: page.location.href});
  }
