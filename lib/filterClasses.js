...
ActiveFilter.prototype =
{
  ...
  setHitCount: function setHitCount(value, window)
  {
    if (value != this._hitCount)
    {
      let oldValue = this._hitCount;
      this._hitCount = value;
      FilterNotifier.triggerListeners("filter.hitCount", this, value, oldValue, window);
    }
    return this._hitCount;
  },
  ...
  setLastHit: function setLastHit(value, window)
  {
    if (value != this._lastHit)
    {
      let oldValue = this._lastHit;
      this._lastHit = value;
      FilterNotifier.triggerListeners("filter.lastHit", this, value, oldValue, window);
    }
    return this._lastHit;
  },
