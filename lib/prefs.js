...
function init()
{
  ...
  Services.scriptloader.loadSubScript("chrome://adblockcash/content/lib/prefsDefaults.js", scope);
...
function triggerListeners(/**String*/ name)
{
  for (let i = 0; i < listeners.length; i++)
  {
    ...
    {
      Cu.reportError(e);
      Cu.reportError(JSON.stringify(listeners[i]));
      Cu.reportError(listeners[i]);
    }
  }
}
