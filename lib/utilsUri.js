 ...
 */
let getBaseDomain = exports.getBaseDomain = function getBaseDomain(/**String*/ hostname) /**String*/
{
 ...
 */
let isThirdParty = exports.isThirdParty = function isThirdParty(/**String*/ requestHost, /**String*/ documentHost)
{
 ...
 */
let extractHostFromURL = exports.extractHostFromURL = function extractHostFromURL(/**String*/ url)
{
 ...
 */
let extractHostFromFrame = exports.extractHostFromFrame = function extractHostFromFrame(frame)
{
 ...
 */
let stripFragmentFromURL = exports.stripFragmentFromURL = function stripFragmentFromURL(/**String*/ url)
{
  return url.replace(/#.*/, "");
}
 ...
 * @constructor
 */
let URI = exports.URI = function URI(/**String*/ spec)
{
  this.spec = spec;
