// This is a concatenated copy of rollbar 1.1.14 files:
// - rollbar/src/shim.js,
// - rollbar/src/shimload.js

exports.initRollbar = (function(window, document){
...
// rollbar/src/shimload.js
var defaultRollbarJsUrl = "/shared/js/rollbar.js";
window._rollbarConfig.rollbarJsUrl = window._rollbarConfig.rollbarJsUrl || defaultRollbarJsUrl;
var r = Rollbar.init(window, window._rollbarConfig);
r.loadFull(window, document, false, window._rollbarConfig);
